 ...
 *
 * Example:
 * <h5> This is the first Instant Article</h5>
 *  or
 * <h5> This is the <b>first</b> Instant Article</h5>
 */
class H5 extends TextContainer
{
    /**
    ...
    /**
     * Structure and create the H5 in a DOMElement.
     *
    ...
    public function toDOMElement($document = null)
    {
        ...
        if (!empty($classes)) {
            $h5->setAttribute('class', implode(' ', $classes));
        }

        $h5->appendChild($this->textToDOMDocumentFragment($document));
