 ...
 *
 * Example:
 * <h6> This is the h6 element Instant Article</h6>
 *  or
 * <h6> This is a <b> h6 element </b> in the  Instant Article</h6>
 */
class H6 extends TextContainer
{
    /**
    ...
    /**
     * Structure and create the H6 in a DOMElement.
     *
    ...
    public function toDOMElement($document = null)
    {
        ...
        if (!empty($classes)) {
            $h6->setAttribute('class', implode(' ', $classes));
        }

        $h6->appendChild($this->textToDOMDocumentFragment($document));
